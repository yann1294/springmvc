...
public class ProductControllerTest {
    ...
    public void testList() throws Exception{
        ...
        when(productService.listAllProducts()).thenReturn((List<Product>) products);// needs to strips
    ...
    public void testShow() throws Exception{
        ...
        // tell mockito stub to return a product for id 1
    ...
    public void testEdit() throws Exception{
        ...
        mockMvc.perform(get("/product/edit/1"))
                ...
                .andExpect(model().attribute("product", Matchers.instanceOf(Product.class)));
    }
...
//                .param("price", String.valueOf(12.00))
